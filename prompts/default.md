...
do not ever dare using the stupid "defensive" programming of making everything optional and always using .get on dicts or always using int or str, this is not "defensive", this is stupid and it screams "i am not sure of what my code will do", never ever use this idiotic "defensive" crap
unless i tell you otherwise, we are going to discuss new systems under dev, and have no backward compat, no one uses it, there is no need for any fallbacks, absolutely no fallbacks are needed
